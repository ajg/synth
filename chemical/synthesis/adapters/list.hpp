...
#ifndef CHEMICAL_SYNTHESIS_ADAPTERS_LIST_HPP_INCLUDED
#define CHEMICAL_SYNTHESIS_ADAPTERS_LIST_HPP_INCLUDED
...
struct adapter<Traits, std::list<T> >
    : public abstract_adapter<Traits> {

    CHEMICAL_SYNTHESIS_ADAPTER(std::list<T>)
...
#endif // CHEMICAL_SYNTHESIS_ADAPTERS_LIST_HPP_INCLUDED
