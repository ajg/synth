...
#ifndef CHEMICAL_SYNTHESIS_ADAPTERS_PAIR_HPP_INCLUDED
#define CHEMICAL_SYNTHESIS_ADAPTERS_PAIR_HPP_INCLUDED
...
struct adapter<Traits, std::pair<First, Second> >
    ...
    CHEMICAL_SYNTHESIS_ADAPTER(pair_type)
  ...
  public:
    ...
    void output(ostream_type& out) const { this->list(out, lexical_cast<string_type>(": ")); }
...
#endif // CHEMICAL_SYNTHESIS_ADAPTERS_PAIR_HPP_INCLUDED
