...
#ifndef AJG_SYNTHESIS_ADAPTERS_LIST_HPP_INCLUDED
#define AJG_SYNTHESIS_ADAPTERS_LIST_HPP_INCLUDED
...
struct adapter<Traits, std::list<T> >
    ...
    AJG_SYNTHESIS_ADAPTER(std::list<T>)
...
#endif // AJG_SYNTHESIS_ADAPTERS_LIST_HPP_INCLUDED
