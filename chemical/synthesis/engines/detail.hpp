...
#ifndef CHEMICAL_SYNTHESIS_ENGINES_DETAIL_HPP_INCLUDED
#define CHEMICAL_SYNTHESIS_ENGINES_DETAIL_HPP_INCLUDED
...
#ifndef CHEMICAL_SYNTHESIS_SEQUENCE_LIMIT
#define CHEMICAL_SYNTHESIS_SEQUENCE_LIMIT 50
#endif

#ifndef CHEMICAL_SYNTHESIS_CONSTRUCT_LIMIT
#define CHEMICAL_SYNTHESIS_CONSTRUCT_LIMIT 10
#endif
...
BOOST_PP_REPEAT(CHEMICAL_SYNTHESIS_SEQUENCE_LIMIT, APPLY_AT, nil)
#undef APPLY_AT
#undef CASE
...
BOOST_PP_REPEAT(CHEMICAL_SYNTHESIS_CONSTRUCT_LIMIT, CONSTRUCT_N, nil)
...
#ifdef _WIN32
  #define CHEMICAL_SYNTHESIS_POPEN  _popen
  #define CHEMICAL_SYNTHESIS_PCLOSE _pclose
#else
  #define CHEMICAL_SYNTHESIS_POPEN  /*std::*/popen
  #define CHEMICAL_SYNTHESIS_PCLOSE /*std::*/pclose
#endif
...
struct pipe : noncopyable {
  public:
    ...
    explicit pipe(std::string const& command, bool const reading = true) {
        if ((file_ = CHEMICAL_SYNTHESIS_POPEN(command.c_str(),
                reading ? "r" : "w")) == 0) {
    ...
    ~pipe() {
        if (CHEMICAL_SYNTHESIS_PCLOSE(file_) == -1) {
...
#endif // CHEMICAL_SYNTHESIS_ENGINES_DETAIL_HPP_INCLUDED
