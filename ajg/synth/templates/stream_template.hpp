...
struct stream_template : base_template<Engine,
  ...
  public:
    ...
    stream_template(istream_type& istream, options_type const& options) : istream_(istream), bidi_istream_(istream_) {
    ...
    stream_template(istream_type const& istream, options_type const& options) : istream_(const_cast<istream_type&>(istream)), bidi_istream_(istream_) {
        this->reset(this->bidi_istream_.begin(), this->bidi_istream_.end(), options);
    }
