...
#ifndef CHEMICAL_SYNTHESIS_ADAPTERS_ARRAY_HPP_INCLUDED
#define CHEMICAL_SYNTHESIS_ADAPTERS_ARRAY_HPP_INCLUDED
...
struct adapter<Traits, T[N]>
    ...
    CHEMICAL_SYNTHESIS_ADAPTER(array_type)
...
struct adapter<Traits, T[]>
    ...
    CHEMICAL_SYNTHESIS_ADAPTER_TYPEDEFS(T const*, adapter);
...
#endif // CHEMICAL_SYNTHESIS_ADAPTERS_ARRAY_HPP_INCLUDED
